...
if __name__ == "__main__":
    ...
    while not shutdown_flag:
        try:
            ...
            # Читаем ток через шунт. INA219 включена в разрыв 5В БП → UPS,
            # шунт ориентирован так, что зарядный ток возвращается отрицательным.
            # Инвертируем: положительный = заряд АКБ, отрицательный = разряд.
